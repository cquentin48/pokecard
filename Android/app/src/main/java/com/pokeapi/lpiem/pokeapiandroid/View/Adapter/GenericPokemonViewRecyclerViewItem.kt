...
class GenericPokemonViewRecyclerViewItem(private val data:PokedexBasicInfosAdapter):RecyclerView.Adapter<GenericInfosPokemonViewHolder>(){
    @SuppressLint("ResourceType")
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GenericInfosPokemonViewHolder =
            GenericInfosPokemonViewHolder(parent)
